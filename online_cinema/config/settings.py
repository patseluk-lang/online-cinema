...
# WhiteNoise serves collected static files in production; runserver serves them locally.
if not DEBUG:
...
STORAGES = {
    ...
    # Hashed, compressed files in production; plain storage for local runs and tests.
